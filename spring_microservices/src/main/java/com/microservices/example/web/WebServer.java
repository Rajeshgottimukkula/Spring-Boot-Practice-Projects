...
public class WebServer {
	...
	public static final String DIVISION_SERVICE_URL = "http://division-service";
	...
	public WebArithmeticController additionController() {
		return new WebArithmeticController(additionService(), subtractionService(),multiplicationService(),divisionService());
	}
