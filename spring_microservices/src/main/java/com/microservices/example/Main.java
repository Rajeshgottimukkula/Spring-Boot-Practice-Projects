...
import com.microservices.example.rest.division.DivisionServer;
import com.microservices.example.rest.multiplication.MultiplicationServer;
...
public class Main {
	public static void main(String[] args) {
		...
		} else if (serverName.equals("division")) {
			DivisionServer.main(args);
